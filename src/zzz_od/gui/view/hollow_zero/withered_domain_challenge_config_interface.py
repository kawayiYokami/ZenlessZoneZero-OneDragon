...
from zzz_od.hollow_zero.hollow_zero_challenge_config import (
    ...
    get_hollow_zero_challenge_new_name,
)


class WitheredDomainChallengeConfigInterface(VerticalScrollInterface):

    def __init__(self, ctx: ZContext, parent=None):
        VerticalScrollInterface.__init__(
            self,
            object_name='withered_domain_challenge_config_interface',
            parent=parent,
            content_widget=None,
            nav_text_cn='挑战配置-枯'
        )
