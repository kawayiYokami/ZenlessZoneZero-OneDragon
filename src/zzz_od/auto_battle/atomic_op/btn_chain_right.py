...
class AtomicBtnChainRight(AtomicBtnBase):
    """连招右按钮操作"""
    ...
    def __init__(
        ...
        AtomicBtnBase.__init__(
            self, ctx, BattleStateEnum.BTN_CHAIN_RIGHT, press, press_time, release
        )
    ...
    def _execute_press(
        ...
        Args:
            ...
            release: 是否松开
        """
        self.ctx.chain_right(press=press, press_time=press_time, release=release)
