...
class AtomicBtnMoveA(AtomicBtnBase):
    """移动A按钮操作"""
    ...
    def __init__(
        ...
        AtomicBtnBase.__init__(
            self, ctx, BattleStateEnum.BTN_MOVE_A, press, press_time, release
        )
    ...
    def _execute_press(
        ...
        Args:
            ...
            release: 是否松开
        """
        self.ctx.move_a(press=press, press_time=press_time, release=release)
