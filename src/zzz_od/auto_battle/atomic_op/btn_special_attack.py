...
class AtomicBtnSpecialAttack(AtomicBtnBase):
    """特殊攻击按钮操作"""
    ...
    def __init__(
        ...
        AtomicBtnBase.__init__(
            self,
            ctx,
            BattleStateEnum.BTN_SWITCH_SPECIAL_ATTACK,
            press,
            press_time,
            release,
        )
    ...
    def _execute_press(
        ...
        Args:
            ...
            release: 是否松开
        """
        self.ctx.special_attack(press=press, press_time=press_time, release=release)
