...
class AtomicBtnChainCancel(AtomicBtnBase):
    """连招取消按钮操作"""
    ...
    def __init__(
        ...
        AtomicBtnBase.__init__(
            self, ctx, BattleStateEnum.BTN_CHAIN_CANCEL, press, press_time, release
        )
    ...
    def _execute_press(
        ...
        Args:
            ...
            release: 是否松开
        """
        self.ctx.chain_cancel(press=press, press_time=press_time, release=release)
