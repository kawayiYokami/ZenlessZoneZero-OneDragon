...
class AtomicBtnNormalAttack(AtomicBtnBase):
    """普通攻击按钮操作"""
    ...
    def __init__(
        ...
        AtomicBtnBase.__init__(
            self,
            ctx,
            BattleStateEnum.BTN_SWITCH_NORMAL_ATTACK,
            press,
            press_time,
            release,
        )
    ...
    def _execute_press(
        ...
        Args:
            ...
            release: 是否松开
        """
        self.ctx.normal_attack(press=press, press_time=press_time, release=release)
