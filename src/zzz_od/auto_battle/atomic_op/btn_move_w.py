...
class AtomicBtnMoveW(AtomicBtnBase):
    """移动W按钮操作"""
    ...
    def __init__(
        ...
        AtomicBtnBase.__init__(
            self, ctx, BattleStateEnum.BTN_MOVE_W, press, press_time, release
        )
    ...
    def _execute_press(
        ...
        Args:
            ...
            release: 是否松开
        """
        self.ctx.move_w(press=press, press_time=press_time, release=release)
