...
class AtomicBtnSwitchNext(AtomicBtnBase):
    """切换下一个角色按钮操作"""
    ...
    def __init__(
        ...
        AtomicBtnBase.__init__(
            self, ctx, BattleStateEnum.BTN_SWITCH_NEXT, press, press_time, release
        )
    ...
    def _execute_press(
        ...
        Args:
            ...
            release: 是否松开
        """
        self.ctx.switch_next(press=press, press_time=press_time, release=release)
