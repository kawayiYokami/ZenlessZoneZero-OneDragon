...
class AtomicBtnLock(AtomicBtnBase):
    """锁定按钮操作"""
    ...
    def __init__(
        ...
        AtomicBtnBase.__init__(
            self, ctx, BattleStateEnum.BTN_LOCK, press, press_time, release
        )
    ...
    def _execute_press(
        ...
        Args:
            ...
            release: 是否松开
        """
        self.ctx.lock(press=press, press_time=press_time, release=release)
